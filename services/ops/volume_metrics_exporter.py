...
# HELP trex_mqtt_data_dir_stat_error 1 if the exporter could not stat the EMQX
# data directory.
...
# HELP trex_mqtt_log_dir_stat_error 1 if the exporter could not stat the EMQX
# log directory.
# TYPE trex_mqtt_log_dir_stat_error gauge
trex_mqtt_log_dir_stat_error {log_error}
# HELP trex_mqtt_volume_metrics_scrape_timestamp_seconds Unix time of the last
# successful scrape generation.
