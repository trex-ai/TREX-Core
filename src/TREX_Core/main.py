...
setup_logging(json_output=False)  # JSON in prod, False for local dev
...
if __name__ == "__main__":
    ...
    config_name = "citylearn_test"
    log.info("Starting simulation!", config_name=config_name)
    runner = Runner(config=config_name, purge=True)
    ...
    log.info("Running simulations", simulations=simulations)
